...
export default class ColumnChart {
  ...
  initEventListeners = () => {
    ...
    document.getElementById('start').addEventListener('change', (e)=>this.range.from = new Date(e.target.value))
    document.getElementById('end').addEventListener('change', (e)=>this.range.to = new Date(e.target.value))

    this.subElements.btn.addEventListener('pointerdown', this.loadNewData);
  }
